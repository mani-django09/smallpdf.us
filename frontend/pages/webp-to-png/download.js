...
export default function DownloadWebpToPng() {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const downloadUrl = `http://localhost:5000/api/download/${jobId}`
      ...
      // Try to get filename from response headers, otherwise use default
  ...
  return (
    <Layout title="Download PNG Images - SmallPDF.us" description="Download your converted PNG images">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className={`${mounted ? "animate-fade-up-delay-1" : "opacity-0"}`}>
                <h1 className="font-display text-xl sm:text-2xl font-bold text-white tracking-tight">
                  WEBP to PNG Conversion Complete!
                </h1>
                <p className="font-body text-teal-100 text-sm">
                  {fileCount} image{fileCount > 1 ? "s" : ""} converted successfully
                </p>
              </div>
            </div>
      ...
      {/* Main Content */}
      <div className="bg-teal-50/50 py-8 sm:py-12 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
            {/* Main Download Section */}
            <div className="lg:col-span-8 space-y-6">
              <div className="bg-white rounded-2xl border border-teal-200/60 shadow-xl overflow-hidden">
                {/* File Header */}
                <div className="bg-gradient-to-r from-teal-700 to-emerald-700 px-6 py-5">
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 bg-gradient-to-br from-teal-500 to-emerald-600 rounded-xl flex items-center justify-center shadow-lg flex-shrink-0">
                    ...
                    <div className="flex-1 min-w-0">
                      <h2 className="font-display text-lg sm:text-xl font-semibold text-white truncate">
                        {fileCount > 1 ? `converted-images.zip` : `converted-image.png`}
                      </h2>
                      <div className="flex items-center gap-3 mt-1.5">
                        ...
                        <span className="text-teal-200 text-sm">
                          {fileCount} PNG image{fileCount > 1 ? "s" : ""}
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="p-6 sm:p-8">
                  <button
                    ...
                    className="group relative w-full bg-gradient-to-r from-teal-600 to-emerald-600 text-white py-4 sm:py-5 px-6 rounded-xl font-semibold text-base sm:text-lg transition-all duration-300 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-3 shadow-lg shadow-teal-500/25 hover:shadow-xl hover:shadow-teal-500/30 hover:from-teal-500 hover:to-emerald-500 overflow-hidden"
                  >
                    ...
                    {downloading ? (
                      ...
                      <>
                        ...
                        <span className="relative">Download PNG {fileCount > 1 ? "Files" : "Image"}</span>
                ...
                {[
                  {
                    ...
                    desc: "Perfect PNG conversion",
                    color: "from-teal-500 to-emerald-600",
                  },
                  {
                    icon: Zap,
                    title: "Fast Processing",
                    desc: "Converted in seconds",
                    color: "from-amber-500 to-orange-600",
                  },
                  {
                    icon: Shield,
                    title: "Secure & Private",
                    desc: "Auto-deleted in 1 hour",
                  ...
                  <div key={i} className="bg-white p-5 rounded-xl border border-teal-200/60">
                    <div
                      className={`w-10 h-10 bg-gradient-to-br ${item.color} rounded-lg flex items-center justify-center mb-3 shadow-lg`}
                    >
              ...
              <div className="bg-white rounded-2xl border border-teal-200/60 overflow-hidden">
                ...
                <div className="p-5 space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-display font-semibold text-teal-600">PNG</span>
                  </div>
                  <div className="flex justify-between items-center">
