...
export default function DownloadSplitPdf() {
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: "My Split PDF Document",
          text: "I just extracted pages from my PDF",
  ...
  return (
    <Layout
      title="Download Your Split PDF - SmallPDF.us"
      description="Your PDF has been split successfully. Download your extracted pages now."
    >
      <style jsx global>{`
            ...
            <div className="flex items-center gap-4">
              ...
              <div className={`${mounted ? "animate-fade-up-delay-1" : "opacity-0"}`}>
                ...
                <p className="font-body text-purple-100 text-sm">
                  {selectedPages.length} page{selectedPages.length > 1 ? "s" : ""} extracted from your document
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-8 space-y-6">
                ...
                <div className="p-6 sm:p-8">
                  ...
                  >
                    ...
                    {downloading ? (
                      ...
                      <>
                        ...
                        <span className="relative">Download Split PDF</span>
                  ...
                  <div className="grid grid-cols-3 gap-3 mt-6">
                    <div className="text-center p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl border border-purple-200">
                      ...
                      <div className="font-body text-xs text-slate-500 mt-1">Pages Extracted</div>
                    </div>
                    <div className="text-center p-4 bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl border border-slate-200">
                      ...
                      <div className="font-body text-xs text-slate-500 mt-1">Original Pages</div>
                    </div>
                    <div className="text-center p-4 bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl border border-slate-200">
                  ...
                  {selectedPages.length > 0 && (
                    <div className="mt-6 pt-6 border-t border-slate-100">
                      <p className="font-display text-sm font-semibold text-slate-700 mb-2">Extracted Pages:</p>
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-6">
                <h3 className="font-display text-lg font-semibold text-slate-900 mb-4">What You Can Do Now</h3>
                <div className="grid grid-cols-2 gap-4">
                  {[
                    {
                      icon: FileOutput,
                      title: "Share Specific Pages",
                      desc: "Send only the relevant pages instead of the full document",
                      color: "bg-purple-600",
                    },
                    { 
                      icon: Layers, 
                      title: "Merge with Other PDFs", 
                      desc: "Combine your extracted pages with other documents", 
                      color: "bg-slate-600" 
                    },
                    {
                      icon: FilePlus,
                      title: "Extract More Pages",
                      desc: "Go back and select different pages from the same PDF",
                      color: "bg-amber-500",
                    },
                    {
                      icon: FileText,
                      title: "Convert to Word",
                      desc: "Transform your PDF pages into editable documents",
                      color: "bg-slate-800",
                    },
                  ].map((item, i) => (
              ...
              <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
                ...
                <div className="p-6">
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    {[
                      { name: "Merge PDF", desc: "Combine multiple PDFs", href: "/merge-pdf", color: "bg-purple-600" },
                      { name: "Compress PDF", desc: "Reduce file size", href: "/compress-pdf", color: "bg-slate-600" },
                      { name: "PDF to Word", desc: "Convert to editable doc", href: "/pdf-to-word", color: "bg-slate-800" },
                    ].map((tool) => (
                      <a
                        key={tool.name}
                        href={tool.href}
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
                <div className="px-5 py-4 border-b border-slate-100 bg-slate-50">
                  <h3 className="font-display text-base font-semibold text-slate-900">Split Summary</h3>
                </div>
                <div className="p-5 space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="font-body text-sm text-slate-600">Pages Extracted</span>
                    <span className="font-display font-semibold text-purple-600">{selectedPages.length}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="font-body text-sm text-slate-600">Original Document</span>
                    <span className="font-display font-semibold text-slate-900">{totalPages} pages</span>
                  </div>
                  <div className="flex justify-between items-center">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-5">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="font-body text-xs text-slate-500">Auto-deletes for privacy</p>
                  </div>
                </div>
                ...
                <p className="font-body text-xs text-slate-500 mt-3 leading-relaxed">
                  Your split PDF will be permanently deleted after 60 minutes to protect your privacy.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-5">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="font-body text-xs text-slate-500">Secure processing</p>
                  </div>
                </div>
