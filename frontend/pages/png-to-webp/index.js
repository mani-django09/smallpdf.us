...
export default function PngToWebp() {
  ...
  const validateFile = (file) => {
    ...
    if (!validTypes.includes(file.type) && !file.name.toLowerCase().endsWith(".png")) {
      return { valid: false, error: "Only PNG image files are accepted for conversion" }
    }

    if (file.size > maxSize) {
      return { valid: false, error: "Each file must be under 50MB in size" }
    }
  ...
  const faqs = [
    {
      question: "Why would I want to convert PNG to WEBP?",
      answer:
        "WEBP files are 25-35% smaller than PNG files. Same image, way less space. Your website loads faster, you use less bandwidth, and Google likes fast websites. It's basically a better version of PNG for the web.",
    },
    {
      question: "What happens to transparent backgrounds?",
      answer:
        "They stay transparent. WEBP handles transparency just like PNG does. Your logos with transparent backgrounds, your overlays, your graphics - everything that was see-through stays see-through.",
    },
    {
      question: "Can I convert a bunch of images at once?",
      answer:
        "Yeah, up to 20 at a time. Just select them all and we'll convert the whole batch. Beats doing them one by one when you've got a whole folder to process.",
    },
    {
      question: "Will WEBP work on all browsers?",
      answer:
        "Pretty much everywhere now. Chrome, Firefox, Edge, Safari - they all support it. Over 95% of people browsing the web can see WEBP images just fine. It's safe to use.",
    },
    {
      question: "Are my images safe during conversion?",
      answer:
        "We encrypt everything when you upload. Process your images on secure servers. Delete both the originals and converted files after an hour. Nobody can see your images except you.",
    },
  ]
  ...
  return (
    <>
      ...
      <Layout
        ...
        description="Turn PNG files into smaller WEBP images without losing quality."
      >
        <style jsx global>{`
        ...
        <div className="bg-gradient-to-br from-white via-blue-50 to-indigo-50 border-b border-blue-200">
          <div className="max-w-4xl mx-auto px-4 pt-4 pb-4 text-center">
            <h1 className="font-display text-3xl md:text-4xl font-bold text-slate-900 mb-3">
              PNG to WEBP <span className="text-blue-600">Online Free</span>
            </h1>

            <p className="font-body text-base text-slate-600 max-w-2xl mx-auto mb-2">
              Convert PNG images to WEBP and make them up to 35% smaller. Same quality, way less file size on{" "}
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-blue-200 p-6">
              {isProcessing ? (
                <div className="py-10 text-center">
                  ...
                  <p className="font-body text-sm text-slate-600">Getting ready to convert...</p>
                  ...
                  >
                    ...
                    <div className="p-10 text-center">
                      ...
                      <h3 className="font-display text-xl font-bold text-slate-900 mb-2">
                        {dragActive ? "Drop Your PNG Files Here!" : "Select PNG Images to Convert"}
                      </h3>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-10">
              <h2 className="font-display text-3xl font-bold text-slate-900 mb-3">
                Why Convert Your PNGs to WEBP
              </h2>
              <p className="font-body text-slate-600 max-w-3xl mx-auto">
                WEBP is basically PNG's smarter younger sibling. Does everything PNG does, but makes the files way smaller.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  title: "Files Get Way Smaller",
                  desc: "WEBP squeezes images down 25-35% more than PNG. A 2MB PNG becomes a 1.3MB WEBP. Same picture, same quality, just takes up less space and loads faster.",
                },
                {
                  icon: "M13 10V3L4 14h7v7l9-11h-7z",
                  title: "Websites Load Faster",
                  desc: "Smaller images mean your pages appear quicker. People don't sit around waiting, Google ranks you higher, and visitors actually stick around instead of bouncing.",
                },
                {
                  icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",
                  title: "Transparency Still Works",
                  desc: "Worried about losing transparent backgrounds? Don't be. WEBP handles transparency exactly like PNG does. Your logos and graphics look identical.",
                },
                {
                  icon: "M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z",
                  title: "Your Images Stay Private",
                  desc: "We encrypt uploads, process everything securely, and delete both your originals and converted files after an hour. Nobody sees your images.",
                },
                {
                  icon: "M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9",
                  title: "Works Everywhere Now",
                  desc: "Chrome, Firefox, Safari, Edge - all the major browsers support WEBP. Over 95% of web users can see WEBP images without any problems. It's ready for prime time.",
                },
                {
                  icon: "M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01",
                  title: "Process Multiple Files",
                  desc: "Got a folder full of PNGs? Convert up to 20 at once. We'll handle them all together and give you everything back in a ZIP file.",
                },
              ].map((feature, index) => (
                <div
                  key={index}
        ...
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 py-12 px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="font-body text-slate-600">Convert your PNG files in seconds</p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Drop your PNG images or click to browse. Add up to 20 files if you want to convert a batch.",
                  color: "bg-blue-600",
                },
                {
                  step: "2",
                  title: "We Convert Them",
                  desc: "Our system turns each PNG into a WEBP file. Keeps the quality, shrinks the size. Takes just a few seconds.",
                  color: "bg-indigo-600",
                },
                {
                  step: "3",
                  title: "Download WEBP Files",
                  desc: "Grab your converted images individually or download them all in a ZIP. Done.",
                  color: "bg-blue-700",
                },
              ].map((item) => (
        ...
        <div className="bg-white py-12 px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="font-body text-slate-600">Quick answers about PNG to WEBP conversion</p>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-slate max-w-none">
              <h2 className="font-display text-2xl font-bold text-slate-900 mb-4">
                What Makes WEBP Better Than PNG
              </h2>
              <p className="font-body text-slate-700 mb-4">
                PNG has been around forever and it works fine. But WEBP is newer and smarter. Google built it specifically to make web images smaller without making them look worse. And it worked.
              </p>
              <p className="font-body text-slate-700 mb-4">
                The main thing you need to know: WEBP files are 25-35% smaller than PNG files. That's huge when you're running a website. Smaller images mean faster loading, which means people don't click away before your page even shows up.
              </p>
              <h3 className="font-display text-xl font-bold text-slate-900 mb-3 mt-6">
                When Should You Use WEBP
              </h3>
              <p className="font-body text-slate-700 mb-4">
                If you're putting images on a website, use WEBP. If you're building an app, use WEBP. If you're trying to make something load fast, use WEBP. The only time you might stick with PNG is if you need to support ancient browsers from 2015, but honestly, almost nobody's on those anymore.
              </p>
              <h3 className="font-display text-xl font-bold text-slate-900 mb-3 mt-6">Real-World Uses</h3>
              <p className="font-body text-slate-700">
                Web developers convert site images to speed up page loads. E-commerce stores shrink product photos to load inventory pages faster. Photographers optimize portfolios for online galleries. Designers prepare graphics for web projects. Anyone who cares about website performance uses WEBP.
              </p>
            </div>
          </div>
        </div>
