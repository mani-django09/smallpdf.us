...
export default function PreviewPngToWebp() {
  ...
  const handleConvert = async () => {
    ...
    const stages = [
      ...
      { progress: 35, text: "Analyzing PNG files...", delay: 500 },
      { progress: 55, text: "Applying WEBP compression...", delay: 600 },
    ...
    try {
      ...
      const convertResponse = await fetch("http://localhost:5011/api/png-to-webp", {
        method: "POST",
        body: formData,
      })
  ...
  return (
    <Layout title="Preview & Convert - PNG to WEBP" description="Review your PNG files and convert them to WEBP">
      <style jsx global>{`
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-display text-lg sm:text-xl font-bold text-white">
                Ready to Convert {filesData.length} PNG Image{filesData.length > 1 ? "s" : ""}
              </h1>
              <p className="font-body text-xs text-white/80">Select images and start optimization</p>
            </div>
          </div>
        </div>
      </div>
                    ...
                    <>
                      ...
                      <div className="mb-5">
                        <div className="flex items-center justify-between mb-3">
                          <h3 className="font-display text-sm font-semibold text-slate-900">Your PNG Images</h3>
                          <button
                            onClick={() =>
                              setSelectedFiles(
                      ...
                      >
                        ...
                        <span>
                          Convert {selectedCount} Image{selectedCount !== 1 ? "s" : ""} to WEBP
                        </span>
                      </button>
                      ...
                      <div className="grid grid-cols-3 gap-3 mt-5">
                        ...
                        <div className="text-center p-3 bg-slate-50 rounded-lg border border-slate-100">
                          ...
                          <div className="font-body text-xs text-slate-500">Smaller</div>
                        </div>
                        <div className="text-center p-3 bg-slate-50 rounded-lg border border-slate-100">
                    ...
                    <div className="py-6">
                      ...
                      <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-3">
                        <p className="font-body text-xs text-emerald-800 text-center">
                          Converting {selectedCount} PNG image{selectedCount !== 1 ? "s" : ""} to WEBP...
                        </p>
                      </div>
                    </div>
                  )}
            ...
            <div className="space-y-4">
              <div className="bg-white rounded-xl p-4 shadow-sm border border-slate-200">
                ...
                <div className="space-y-2.5">
                  {[
                    { icon: Sparkles, text: "Up to 35% smaller files", color: "text-emerald-600 bg-emerald-100" },
              ...
              <div className="bg-white rounded-xl p-4 shadow-sm border border-slate-200">
                ...
                <div className="space-y-2">
                  {[
                    { num: "1", text: "Upload PNG files", color: "bg-emerald-600" },
                    { num: "2", text: "Select & preview", color: "bg-slate-600" },
                    { num: "3", text: "Download WEBP files", color: "bg-slate-800" },
                  ].map((step, i) => (
                    <div key={i} className="flex items-center gap-2.5">
                      <div
