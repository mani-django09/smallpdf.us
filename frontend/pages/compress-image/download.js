...
import { Download, Minimize2, CheckCircle, Share2, RefreshCw, Shield, Zap, Copy, Sparkles, ArrowRight, Lock, Timer } from 'lucide-react'
...
export default function DownloadCompressImage() {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      // Updated filename logic to handle both single files and ZIP
  ...
  return (
    <Layout title="Download Compressed Images" description="Download your optimized images">
      <style jsx global>{`
            ...
            <div className="flex items-center gap-4">
              ...
              <div className={`${mounted ? "animate-fade-up-delay-1" : "opacity-0"}`}>
                ...
                <p className="font-body text-purple-100 text-sm">
                  {fileCount} image{fileCount > 1 ? "s" : ""} compressed • {savedPercentage}% size reduction
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-8 space-y-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h2 className="font-display text-lg sm:text-xl font-semibold text-white truncate">
                        {fileCount > 1 ? `compressed-images.zip` : `compressed-image.${compressResult?.files?.[0]?.originalName?.split('.').pop() || 'jpg'}`}
                      </h2>
                      <div className="flex items-center gap-3 mt-1.5">
                        ...
                        <span className="text-slate-400 text-sm">
                          {fileCount} compressed image{fileCount > 1 ? "s" : ""}
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="p-6 sm:p-8">
                  ...
                  >
                    ...
                    {downloading ? (
                      ...
                      <>
                        ...
                        <span className="relative">Download Compressed {fileCount > 1 ? "Files" : "Image"}</span>
                  ...
                  <div className="grid grid-cols-3 gap-3 mt-6">
                    ...
                    <div className="text-center p-4 bg-slate-50 rounded-xl border border-slate-100">
                      ...
                      <div className="font-body text-xs text-slate-500 mt-1">Saved</div>
                    </div>
                    <div className="text-center p-4 bg-slate-50 rounded-xl border border-slate-100">
                      <div className="font-display text-2xl sm:text-3xl font-bold text-slate-900">
                        {(compressedSize / 1024 / 1024).toFixed(1)}MB
                      </div>
                      <div className="font-body text-xs text-slate-500 mt-1">New Size</div>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { icon: Zap, title: "Ultra Fast", desc: "Compressed in seconds", color: "bg-amber-500" },
                  { icon: Shield, title: "Private & Secure", desc: "Auto-deleted in 1 hour", color: "bg-slate-600" },
                  {
                    icon: Minimize2,
                    title: "Huge Savings",
                    desc: `${savedPercentage}% size reduction`,
                    color: "bg-green-600",
                  },
                ].map((item, i) => (
              ...
              <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
                ...
                <div className="p-5 space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="font-body text-sm text-slate-600">Images Compressed</span>
                  ...
                  <div className="pt-3 border-t border-slate-100">
                    <div className="flex justify-between items-center">
                      <span className="font-body text-sm text-slate-600">Space Saved</span>
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-5">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="font-body text-xs text-slate-500">Auto-delete for privacy</p>
                  </div>
                </div>
